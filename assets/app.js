...
const LOCALES=["en","ru","de","fr","ja","zh-Hans"];let dict=null;
...
async function render(){const all=await loadDict(),code=lang(),t=all[code]||all.en,u=t.ui;document.documentElement.lang=code;const sel=document.getElementById("lang");if(sel)sel.value=code;
...
document.addEventListener("DOMContentLoaded",()=>{const s=document.getElementById("lang");if(s)s.addEventListener("change",()=>{localStorage.setItem("dr-lang",s.value);render()});render()});
